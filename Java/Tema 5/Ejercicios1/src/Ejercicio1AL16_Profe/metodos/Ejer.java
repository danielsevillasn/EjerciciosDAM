...
public class Ejer {
   ...
   * @return  verdadero si el número que se pasa como parámetro es capicúa y falso en caso contrario
   */
   ...
   * Un número primo es un número natural mayor que 1 y divisible únicamente entre el mismo y entre 1.
   *
   * @param x número del que se quiere saber si es primo
   * @return  verdadero si el número que se pasa como parámetro es primo y falso    *          en caso contrario
   */
  ...
  public static int digitos(long x) {
    ...
    if (x == 0) {
      ...
      int n = 0;
      while (x > 0) {
        x = x / 10; // se le quita un dígitos a x
  ...
  /**
  /* Devuelve el dígitos que esté en la posición de un número entero. Se empieza contando por el 0 y de izquierda a derecha.
   *
   * @param x número entero
   * @param n posición dentro del número x
   * @return  dígitos que esté en la posición n del número x   empezando a contar por el 0 y de izquierda a derecha
   */
  ...
  /**
  /* Devuelve el dígitos que esté en la posición n de un número entero. Se empieza contando por el 0 y de izquierda a derecha.
   *
   * @param x número entero
   * @param n posición dentro del número x
   * @return  dígitos que esté en la posición n del número x
  ...
  /**
   * Da la posición de la primera ocurrencia de un dígitos dentro de un número entero. Si no se encuentra, devuelve -1.
   *
   * @param x número entero
   * @param d dígitos a buscar dentro del número
   * @return  posición de la primera ocurrencia del dígitos dentro del número o -1 si no se encuentra
   */
   ...
   * @param x número entero
   * @param d dígitos a buscar dentro del número
   * @return  posición de la primera ocurrencia del dígitos dentro del número o
   ...
   *
   * @param x número entero
   * @param d dígitos que se le va a pegar por la derecha
   ...
   *
   * @param x número entero
   * @param d dígitos que se le va a pegar por la izquierda
   ...
   * @return       trozo de número compuesto por todos los dígitos que van desde la posición inicial a la posición final incluyendo ambos
   */
   ...
   *
   * @param x entero inicial
   * @param y entero final
   * 
   */
  public static void primosEntre(int x, int y) {
   ...
   /**
   *  16. Muestra los números capicúa que hay entre dos números.
   *
   * @param x entero inicial
   * @param y entero final
   * 
   */
  public static void  escapicuaEntre(int x, int y) {
