...
public class Opciones {
    ...
    /**
     * Pide datos para una matriz cuadrada de rango 3 y comprueba si es magica
     *
     *
     * @param nada
     * @return nada, solo muestra por pantalla
     */

    // El void sirve para cuando no quieres devolver ningun valor
    ...
    public static void matrizMagica() {
        ...
        // Le atribuye los valores de la suma tanto de las filas como de las columnas a
        // 2 array e imprime el array
    ...
    /**
     * Comprueba si el idioma es javalandia y si es lo traduce
     * 
     *
     * @param nada
     * @return nada, solo muestra por pantalla
     */
    public static void javalandia() {
        System.out.println("Bienvenido a JAVALANDIA: Javalin, javalon ---- javalen, len, len");

        // Utiliza el metodo pedir cadena para pedir un valor tipo string incluyendo el
        // mensaje que ha de ir precedido a dame
        String frase = Datos.pedirCadena("una frase:");
