package POO.propuestos.ARRAYS.Ejer3ColeccionDiscos;
    ...
    do {
      ...
      case 3:
       ...
       /* X int i = -1;
        do {
          i++;
        } while (!((discos[i].getCodigo()).equals(codigoIntroducido)) || i<discos.length);
       /* */
       for(int i=0; i< discos.length; i++){
        ...
        System.out.println("Código: " + discos[lugar].getCodigo());
        System.out.print("Nuevo código: ");
        codigoIntroducido = s.nextLine();
        if (!codigoIntroducido.equals("")) {
          discos[lugar].setCodigo(codigoIntroducido);
        }
        
        System.out.println("Autor: " + discos[lugar].getAutor());
        System.out.print("Nuevo autor: ");
        autorIntroducido = s.nextLine();
        if (!autorIntroducido.equals("")) {
          discos[lugar].setAutor(autorIntroducido);
        }
        
        System.out.println("Título: " + discos[lugar].getTitulo());
        System.out.print("Nuevo título: ");
        tituloIntroducido = s.nextLine();
        if (!tituloIntroducido.equals("")) {
          discos[lugar].setTitulo(tituloIntroducido);
        }
        
        System.out.println("Género: " + discos[lugar].getGenero());
        System.out.print("Nuevo género: ");
        generoIntroducido = s.nextLine();
        if (!generoIntroducido.equals("")) {
          discos[lugar].setGenero(generoIntroducido);
        }
        
        System.out.println("Duración: " + discos[lugar].getDuracion());
        System.out.print("Duración: ");
        final String duracionIntroducidaString = s.nextLine();
        if (!duracionIntroducidaString.equals("")) {
          discos[lugar].setDuracion(Integer.parseInt(duracionIntroducidaString));
        }
